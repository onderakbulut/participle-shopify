...
document.querySelector('.push-menu').addEventListener('click', (e) => {
    ...
    if(mobileMenu.classList.contains('show')){
        ...
        let top = ( navbarMobile.getBoundingClientRect().top + navbarMobile.getBoundingClientRect().height) - document.documentElement.scrollTop;
        
        document.querySelector('.mobile-menu').style.top = top + 'px';
...
document.querySelectorAll('.mobile-menu summary').forEach((btn) => {
    btn.addEventListener('click', (e) => {
        const isOpen = e.currentTarget.parentNode.classList.contains('submenu-open');
        if(!isOpen){
...
let mask = document.querySelector('.unmask');
if(mask){
    mask.addEventListener('click',(e) => {
        e.preventDefault;
        if (mask.previousElementSibling.getAttribute('type') == 'password')
            mask.previousElementSibling.type = 'text';
        else
            mask.previousElementSibling.type = 'password';                
